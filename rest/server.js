...
if(redis_uri != undefined) {
    ...
    subscriber_log = redis.createClient(redis_uri);
...
app.post('/upload' , upload.single('file') , (req,res, next) => {
    ...
    fs.readFile(req.file.path, (err, data) => {
        ...
        publisher.publish("sentiment_analysis_py", "file:" + req.file.path);
    })
...
app.get('*' , (req , res, next) => {
    ...
    publisher.publish("sentiment_analysis_py", "param:" + param);
...
*/
app.use("*", (req, res, next) => {
    subscriber_log.on('message', (channel, msg) => {
        console.log("diarization_node_log", msg);
    });
...
app.listen(port , () => {
    ...
    subscriber_log.subscribe("diarization_node_log");
});